...
This is the contract. To take this concept through the SSR pipeline \+ greenlight gate, the concept author must produce everything below. Each row maps to a specific stage in [`game-testing-approach.md`](http://../strategy/game-testing-approach.md).
