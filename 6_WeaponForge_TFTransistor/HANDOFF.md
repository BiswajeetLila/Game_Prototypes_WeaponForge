...
1. [`docs/superpowers/specs/2026-06-22-directional-keys-and-prototype-controls.md`](docs/superpowers/specs/2026-06-22-directional-keys-and-prototype-controls.md) — **FRESHEST.** Directional Keys (resolves the 3-element priority question), Key tiers (2 common + epic Star/Tempest), Splitter redefinition, Battle button + Replay HP fix, 5-component eval, verified parity numbers.
...
**⚠️ Uncommitted (06-21 + 06-22):** `ftue-beat5.html` (Path Y + playtest fixes + **06-22 directional Keys / Battle button / Replay HP fix**), `2026-06-21-craft-refinements-and-synergy-axes.md` (incl. §6), the **new `2026-06-22-directional-keys-and-prototype-controls.md`**, and the GD spec gap #16. Committed through 06-20: `5e79bc9` (GD King correction), `a02cf88` (staged-direction pile). *Unrelated/untouched:* reference-games research corpus + pre-existing churn.
