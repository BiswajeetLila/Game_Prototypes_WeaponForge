...
**Date:** 2026-05-22
**Direction:** A (canonical BASE, per `docs/01_GDD.md`)
...
Validate the core casual-mobile-RPG forge→fight loop from `01_GDD.md` with a playable single-stage slice. Stress-test 8 design pillars in one ~1-day build. No meta layer (gacha/BP/AFK deferred).

## Pillars under test (from `01_GDD.md`)
...
### Excluded
- Merge mechanic (Direction B leftover, not in `01_GDD.md`)
