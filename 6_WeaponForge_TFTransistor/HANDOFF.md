...
1. **The two 06-22 docs — FRESHEST:** [`2026-06-22-directional-keys-and-prototype-controls.md`](docs/superpowers/specs/2026-06-22-directional-keys-and-prototype-controls.md) (directional Keys resolving the 3-element priority question, Key tiers = 2 common + epic Star/Tempest, Splitter, Battle button + Replay HP fix) **and** [`2026-06-22-mana-tick-economy.md`](docs/superpowers/specs/2026-06-22-mana-tick-economy.md) (mana = ticks: one per cluster/combo/lone tile → the firing-cadence/tempo economy). Both 5-component-evaluated with verified parity numbers.
