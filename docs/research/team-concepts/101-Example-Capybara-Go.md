# Capybara Go — Worked Example

**Owner:** Illustrative — retrofitted from existing research as a worked example of [`new-game-concept-v2.md`](../new-game-concept-v2.md). Not an active concept.
...
- [x] Text write-ups for SSR
  - [x] Full description of core loop (~125 words)
  - [x] Full description of core loop + 1 meta progression (~165 words)
  - [x] Store-page variant (~50 words)
  - [x] First 1–5 minutes the player experiences (~270 words)
  - [x] D1–D14 player journey / progression description (~360 words)
- [ ] Prototype
