...
(() => {
  ...
  /* Beats section currently renders a single <video> placeholder (see
     teammate-deck.html `#beats`). The 5-mockup carousel was retired pending
     a beat-caption content pass; the static markup needs no JS. */
